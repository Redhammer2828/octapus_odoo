...
class VendorsReportWizard(models.TransientModel):
    ...
    def calculate_rate(self, record):
        """Calculate the rate based on member type."""
        return self._calculate_amount(record)
