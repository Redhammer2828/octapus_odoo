...
class MemberSearch(models.Model):
    ...
    def search_member(self):
        ...
        partner_ids = partner_obj.search(search_domain, order='create_date desc',limit=10000)

        # If no partners are found, show the wizard to create a temporary member
        if not partner_ids:
            return {
